          ...
          <div className="bg-gray-900 text-white rounded-lg overflow-hidden shadow-xl max-w-sm w-[75vw]">
            ...
            <div className="px-6 pt-6 pb-4">
              <p className="text-white text-base">
                Unfortunately, it is not yet possible to code like a pro on
                mobile. Please use a desktop device.
              </p>
            </div>
              ...
              <div className="flex flex-col items-center space-y-4 mt-[75px]">
                ...
                >
                  <div className="flex flex-row justify-center items-center">
                    <img className="h-[35px]" alt="google" src="/google1.png" />
            ...
            {selected === "login" && (
              <div>
                ...
                <div className="mb-4 mt-6">
                  ...
                  ></TextField>
                  <label className="text-red-500 w-full h-[20px] text-sm mt-2 mb-2 block">
                    {error}
                  </label>
                </div>
                <button
                  ...
                  className="bg-blue-600 hover:bg-blue-700 text-white w-full py-2.5 font-medium rounded-3xl"
                >
                  Sign In
                </button>
              </div>
