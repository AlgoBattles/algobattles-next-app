  ...
  const InviteComponent = ({ item }: { item: Invite }): React.ReactElement => {
    ...
    return (
      <div
        key={uuidv4()}
        style={{ zIndex: 9999 }}
        className="flex flex-row items-center relative mb-2 z-50"
      >
        <img
          src={item.sender !== "" ? `/${item.senderAvatar}` : `/anon.jpg`}
          alt="avatar"
  ...
  return (
    <div className="border-b border-gray-300 relative">
      <div
        ...
        onClick={() => {
          showWarningModal("/home", "Are you sure you want to leave?");
        }}
      >
        <h1
          className="font-luckiest-guy text-4xl text-left w-1/4 mt-5 ml-5 mb-2 cursor-pointer"
